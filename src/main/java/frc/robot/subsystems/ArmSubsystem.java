...
public class ArmSubsystem extends SubsystemBase
{
  ...
  private final SmartMotorControllerConfig motorConfig = new SmartMotorControllerConfig(this)
      ...
      .withClosedLoopController(new ExponentialProfilePIDController(20, 0, 0, ExponentialProfilePIDController
      .createArmConstraints(Volts.of(10), motors, weight, length, gearing)))
      .withSoftLimit(Rotations.of(0.288), Rotations.of(0.652))
      .withGearing(gearing)
      ...
      .withFeedforward(new ArmFeedforward(0, 0.005, 0.01, 0))
  ...
  private       ArmConfig m_config = new ArmConfig(motor)
      .withLength(length)
      .withHardLimit(Rotations.of(0.288), Rotations.of(0.652))
      .withTelemetry("ArmSubsystem", TelemetryVerbosity.HIGH)
      .withMass(Pounds.of(3))
      //.withStartingPosition(Degrees.of(0))
      .withHorizontalZero(Rotations.of(0.590))
  ...
  {
    return arm.runTo(angle, Degrees.of(5));
  }
